  ...
  return (
    <div className="w-full">
      <div className="mb-8 text-center">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">Eliminador de Fondos</h2>
        <p className="text-gray-600">Elimina el fondo de tus imágenes automáticamente.</p>
      </div>
